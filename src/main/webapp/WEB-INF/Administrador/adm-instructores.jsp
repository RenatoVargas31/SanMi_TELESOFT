...
<head>
    ...
    <title>Administrador: Personal de Serenazgo</title>
    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="adm-dashboard.html" class="menu-link">
                ...
                <li class="menu-header small text-uppercase">
                    <span class="menu-header-text" data-i18n="Eventos">Usuarios</span>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="adm-solicitudRegistro.html" class="menu-link"><!--Zona de linkeo href: -->
                                <div class="text-truncate" data-i18n="Solicitudes de registro">Solicitudes de registro</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="adm-usuariosHabilitados.html" class="menu-link"><!--Zona de linkeo href: -->
                                <div class="text-truncate" data-i18n="Usuarios habilitados">Usuarios habilitados</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="adm-usuariosBaneados.html" class="menu-link"><!--Zona de linkeo href: -->
                ...
                <li class="menu-item">
                    <a href="adm-personalSerenazgo.html" class="menu-link ">
                ...
                <li class="menu-item active">
                    <a href="adm-instructores.html" class="menu-link menu-toggle">
                ...
                <!-- Cards -->
                <li class="menu-item">
                    <a href="adm-faqs.html" class="menu-link menu">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/assets/img/avatars/2.png" alt
                                                             class="w-px-40 h-auto rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/assets/img/avatars/9.png" alt
                                                             class="w-px-40 h-auto rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/assets/img/avatars/5.png" alt
                                                             class="w-px-40 h-auto rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/assets/img/avatars/6.png" alt
                                                             class="w-px-40 h-auto rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="../v.Sistema/sistema-login.html" target="_blank">
