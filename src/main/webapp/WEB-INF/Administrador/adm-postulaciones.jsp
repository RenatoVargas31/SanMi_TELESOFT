...
<head>
    ...
    <title>SanMi  |  Postulaciones</title>
                    ...
                    <div class="card">
                        <div class="card-datatable table-responsive">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="m-4 fw-bold">Postulaciones a Coordinadora</h3>
                            </div>
                            <table id="table-postulaciones" class="datatables-basic table border-top">
                                <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%if (usuario.getRol().equals("Vecino")){%>
                                                ...
                                                <div class="modal fade" id="modalCultura<%= usuario.getIdUsuarios() %>" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <b> ¿Está seguro de aceptar a <%=usuario.getNombreUsuario()%> <%=usuario.getApellidoUsuario()%> como Coordinadora de Cultura? </b>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <a class="btn btn-primary"  href="<%=request.getContextPath()%>/ServletAdministrador?action=aceptarCoordinador&idDeUsuario=<%= usuario.getIdUsuarios() %>&idTipo=1">Si</a>
                                                ...
                                                <div class="modal fade" id="modalDeporte<%= usuario.getIdUsuarios() %>" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" >Aceptar como Coordinadora</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <b> ¿Está seguro de aceptar a <%=usuario.getNombreUsuario()%> <%=usuario.getApellidoUsuario()%> como Coordinadora de Deporte? </b>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <a class="btn btn-primary"  href="<%=request.getContextPath()%>/ServletAdministrador?action=aceptarCoordinador&idDeUsuario=<%= usuario.getIdUsuarios() %>&idTipo=2">Si</a>
                                                                <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close">Cancelar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="modalDelete<%= usuario.getIdUsuarios() %>" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a class="btn btn-primary"  href="<%=request.getContextPath()%>/ServletAdministrador?action=eliminarPostulacion&idDeUsuario=<%= usuario.getIdUsuarios() %>">Si</a>
                                                                <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close">Cancelar</button>
                                                            </div>
                                                        </div>
                                                    </div>
