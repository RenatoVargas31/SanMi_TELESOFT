    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
                <a href="${pageContext.request.contextPath}/ServletVecino?action=mostrarInicio" class="app-brand-link">
             ...
             <ul class="menu-inner py-1">
                <!-- Inicio -->
                 <li class="menu-item <%= "inicio".equals(currentPage) ? "active" : "" %>">
                     <a href="${pageContext.request.contextPath}/ServletVecino?action=mostrarInicio" class="menu-link">
                 ...
                 <li class="menu-item <%= ("catalogoEventos".equals(currentPage) || "eventosInscritos".equals(currentPage)) ? "active open" : "" %>">
                     ...
                     <ul class="menu-sub">
                         <li class="menu-item <%= "catalogoEventos".equals(currentPage) ? "active" : "" %>">
                             <a href="${pageContext.request.contextPath}/ServletVecino?action=listaEventos" class="menu-link">
                         ...
                         <li class="menu-item <%= "eventosInscritos".equals(currentPage) ? "active" : "" %>">
                             <a href="${pageContext.request.contextPath}/ServletVecino?action=eventosInscritos" class="menu-link">
                 ...
                 <li class="menu-item <%= ("reportarIncidencia".equals(currentPage) || "misIncidencias".equals(currentPage) || "incidenciasGenerales".equals(currentPage)) ? "active open" : "" %>">
                     ...
                     <ul class="menu-sub">
                         <li class="menu-item <%= "reportarIncidencia".equals(currentPage) ? "active" : "" %>">
                             <a href="${pageContext.request.contextPath}/ServletVecino?action=reportarIncidencia" class="menu-link">
                         ...
                         <li class="menu-item <%= "misIncidencias".equals(currentPage) ? "active" : "" %>">
                             <a href="${pageContext.request.contextPath}/ServletVecino?action=misIncidencias" class="menu-link">
                         ...
                         <li class="menu-item <%= "incidenciasGenerales".equals(currentPage) ? "active" : "" %>">
                             <a href="${pageContext.request.contextPath}/ServletVecino?action=incidenciasGenerales" class="menu-link">
                 ...
                 <li class="menu-item <%= "ayuda".equals(currentPage) ? "active" : "" %>">
                     <a href="${pageContext.request.contextPath}/ServletVecino?action=mostrarAyuda" class="menu-link">
