    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <span class="badge bg-label-primary rounded-2">
              <i class="bx bx-box bx-md"></i>
                                        ...
                                        <div>
                                            <h2 class="mb-0">
                                                <span class="align-middle">Preguntas acerca del funcionamiento y rol de Serenazgo</span>
                                            </h2>
                                        ...
                                        <div class="card accordion-item active">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    ¿Cómo funciona el rol de Serenazgo en la página?
                                                </button>
                                            </h2>
                                            ...
                                            <div id="accordionPayment-1" class="accordion-collapse collapse show">
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    Serenazgo en la página es facilitar el reporte de incidencias por
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    de incidencia, el equipo de Serenazgo se encarga de actualizar el
                                                ...
                                                <div class="accordion-body">
                                                    Comunicación con la comunidad: El Serenazgo utiliza la página como
                                        ...
                                        <div class="card accordion-item">
                                            ...
                                            <div id="accordionPayment-3" class="accordion-collapse collapse">
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    telefónica al serenazgo, a los bomberos o a una ambulancia, según
                                        ...
                                        <div class="card accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    ¿Qué objetivo tenemos como Serenazgo en San Miguel?
                                                </button>
                                            </h2>
                                            <div id="accordionPayment-5" class="accordion-collapse collapse">
                                                <div class="accordion-body">Como serenazgo en San Miguel, nuestros
      ...
      <span class="badge bg-label-primary rounded-2 my-3">
        <i class="bx bx-envelope bx-sm"></i>
                                ...
                                <p>La mejor forma para obtener soluciones rápidas</p>
                            </div>
                        </div>
                    </div>
                    <!-- /Contact -->
