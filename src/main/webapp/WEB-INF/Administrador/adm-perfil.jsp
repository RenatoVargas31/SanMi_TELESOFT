...
<head>
    ...
    <title>SanMi | Perfil Administrador</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h3 class="address-title fw-bold">Perfil Administrador</h3>
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4">
                                ...
                                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                                        <img src="${pageContext.request.contextPath}/assets/img/avatars/1.png" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
                                    </div>
                                            ...
                                            <div class="user-profile-info">
                                                ...
                                                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                    <li class="list-inline-item fw-medium">
                                                        <i class='bx bx-pen'></i> Administrador
                                                    </li>
                                                    <li class="list-inline-item fw-medium">
                                    ...
                                    <form id="formAccountSettings" method="GET" onsubmit="return false">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <p class="form-control-plaintext" id="phoneNumber"><%= usuario.getTelefonoUsuario() %></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
