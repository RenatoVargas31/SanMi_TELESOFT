                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="rounded-2 text-center mb-3">
                                            <a href="<%=request.getContextPath()%>/ServletVecino?action=viewEvento&id=<%= evento.getIdEventos() %>">
                                                ...
                                                <img style="height: 200px; width: 390px; border-radius: 10px;" class="img-fluid" src="${pageContext.request.contextPath}/ServletVecino?action=servirImagenIncidencia&id=<%= evento.getIdEventos() %>" alt="Foto del reporte">
                                                <% } else {%>
