        ...
        <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="faq-header d-flex flex-column justify-content-center align-items-center h-px-300 position-relative">
                        ...
                        <p class="text-center mb-0 px-3, text-muted fw-black">Aqui te mostramos las preguntas frecuentes
                            acerca del rol de Vecino San Miguelino</p>
                    </div>
            ...
            <span class="badge bg-label-primary rounded-2">
              <i class="bx bx-box bx-md"></i>
                                        ...
                                        <div>
                                            <h2 class="mb-0">
                                                <span class="align-middle">Preguntas acerca del funcionamiento y rol como Vecino San Miguelino</span>
                                            </h2>
                                        ...
                                        <div class="card accordion-item active">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    ¿Cómo funciona el rol de Vecino San Miguelino en la página?
                                                </button>
                                            </h2>
                                            ...
                                            <div class="card accordion-item">
                                                ...
                                                <div id="accordionPayment-2" class="accordion-collapse collapse">
                                                    <div class="accordion-body">
                                                        Si olvidaste tu contraseña, puedes utilizar la opción de recuperación de contraseña en la plataforma. Se te pedirá que ingreses tu correo electrónico registrado y luego recibirás un enlace para restablecer tu contraseña.
                                                    </div>
                                            ...
                                            <div class="card accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        ¿Cómo puedo ver la lista de eventos disponibles?
                                                    </button>
                                                </h2>
                                                <div id="accordionPayment-3" class="accordion-collapse collapse">
                                                    <div class="accordion-body">
                                                        Puedes ver la lista de eventos disponibles en la plataforma después de iniciar sesión. Los eventos estarán divididos por categorías como Cultura y Deportes.
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        ¿Cómo puedo generar una incidencia?
                                                    </button>
                                                </h2>
                                                <div id="accordionPayment-5" class="accordion-collapse collapse">
                                                    <div class="accordion-body">
                                                        Para generar una incidencia, selecciona la opción correspondiente en la plataforma e ingresa los detalles requeridos, como el nombre de la incidencia, lugar exacto, referencia, foto, tipo de incidencia y contacto (opcional).
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
