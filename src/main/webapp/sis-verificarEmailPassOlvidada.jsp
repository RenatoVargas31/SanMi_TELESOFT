        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Envío exitoso ✅</h4>
                    <p class="mb-4">Felicidades!! Le acabamos de enviar un enlace de reestablecimiento a su correo. No se olvide de revisar la carpeta de spam y seguir las instrucciones.</p>
