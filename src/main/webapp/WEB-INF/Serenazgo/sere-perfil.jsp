...
<head>
    ...
    <title>SanMi | Perfil Serenazgo</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h3 class="address-title fw-bold">Perfil Serenazgo</h3>
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4">
                                ...
                                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                                        <img src="${pageContext.request.contextPath}/assets/img/avatars/23.png" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-4">
                                ...
                                <hr class="my-0">
                                <div class="card-body">
                                    <form action="ServletSerenazgo" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <p class="form-control-plaintext" id="tipo">Dispatcher</p>
                                            </div>
                                        </div>
