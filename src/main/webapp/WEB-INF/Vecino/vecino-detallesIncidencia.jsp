                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <button class="btn btn-label-primary" type="button" onclick="window.location.href='${pageContext.request.contextPath}/ServletVecino?action=misIncidencias';">Atrás</button>
                            </div>
                        </div>
                    </div>
                </div>
