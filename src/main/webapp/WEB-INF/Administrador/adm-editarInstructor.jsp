...
<jsp:useBean id="profesor" type="com.example.sanmi_telesoft.beans.Profesor" scope="request" />
<!DOCTYPE html>
...
<head>
    ...
    <title>Administrador: Editar Instructor</title>
                                    ...
                                    <div class="col-md mb-md-0 mb-3">
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioDeporte">
                                                ...
                                                <input name="tipoProfesor" class="form-check-input" type="radio" value="Deporte" id="customRadioDeporte" ${checkedForm == 'Deporte' ? 'checked' : ''}/>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md mb-md-0 mb-3">
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioCultura">
                                                ...
                                                <input name="tipoProfesor" class="form-check-input" type="radio" value="Cultura" id="customRadioCultura" ${checkedForm == 'Cultura' ? 'checked' : ''}/>
                                            </label>
                                        </div>
                                    </div>
                                </div>
