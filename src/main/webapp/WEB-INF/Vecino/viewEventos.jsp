    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="vecino_index.html" class="menu-link ">
            ...
            <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="150px" height="70px"
                        ...
                        <g transform="translate(0.000000,70.000000) scale(0.100000,-0.100000)" fill="#277da1"
                           stroke="none">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <nav>
                        <ul class="breadcrumb" style="margin-bottom: -30px" >
                            ...
                            <li><a href="<%=request.getContextPath()%>/ServletVecino?action=view&id=<%= evento.getIdEventos() %>" style="color:black"><%= evento.getNombreEvento() %></a></li>
                        </ul>
                    </nav>
              ...
              <span class="d-flex flex-column">
                <span class="h5 mb-1">Descripción</span>
                                        ...
                                        <div style="cursor:default" id="chapterOne"
